...
program ChargeMigration
    ...
    if(.not. SaveDensity)then
        ...
        !        call ComputeNewBeckeMatrix1(WeightV, OrbTab, Becke_new, AtCoord)!!this works
        call ComputeNewBeckeMatrix1(WeightV, OrbTab, Becke_new, R_el) !!using electronic barycenter
        !        call ComputeNewBeckeMatrix2(WeightV, OrbTab, Becke_new1, gridv) !!testing
    end if
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

...
from def_functions import ExecutePymolcasWithErrorPrint, ExecuteNoWrite, Find, GetValueOfAsString
from os import path
import sys
...
def SelectionOfActiveSpace(ini_file):
    ...
    print("Active space selected, please update the input file accordingly before proceeding."
          ...
          "these Orbital file, thus keywords 'RAS(1-3) =' should be removed to avoid "

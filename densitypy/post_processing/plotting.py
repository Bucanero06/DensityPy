...
data = pd.read_csv('/home/ruben/PycharmProjects/DensityPy/Studies/cluttertest/sim/Dipole/DipoleFT_ww',
                 sep='\s+', header=None, names=['X', 'Y', 'X-real-value', 'X-imag-value', 'Y-real-value', 'Y-imag-value', 'Z-real-value', 'Z-imag-value'])
...
average_ww_dim = np.sqrt((data["X-real-value"]**2 + data["X-imag-value"]**2 + data["Y-real-value"]**2 + data["Y-imag-value"]**2 + data["Z-real-value"]**2 + data["Z-imag-value"]**2) / 3)
